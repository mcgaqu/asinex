...
def get_LAYOUT_index0():
    ...
    # ['_00_10', 'head1', 1, 0,'setAttr__tags', '', 'Theme',
    #                                 'href:https://www.w3schools.com/lib/w3-theme-cyan.css'], # theme
    # ['_00_20', 'head2', 1, 0,'setAttr__tags', '', 'Font-awesome', ], # index.css
    ...
    # ['_10_10_40_90', 'navbar9', 1, 0,'loadNavbar', 'innerHTML__name', 'navbar9',   'href:#main9','fa-th'],
    #-------------------------------------------------
    ...
    ['_20_20_50_10', 'main251', 1, 1,'loadCard2', 'loadCard2', 'Asesoría Legal', '', 'fa-th', '',
                        get_params('main25n')],
    ['_20_20_50_20', 'main252', 1, 1,'loadCard2', 'loadCard2', 'Fiscal y Contabilidad', '', 'fa-th', '',
                        get_params('main25n')],
    ['_20_20_50_30', 'main253', 1, 1,'loadCard2', 'loadCard2', 'Seguros', '', 'fa-th', '',
                        get_params('main25n')],
    ['_20_20_50_40', 'main254', 1, 1,'loadCard2', 'loadCard2', 'ECCO', '', 'fa-th', '',
                        get_params('main25n')],
    ['_20_20_50_50', 'main255', 1, 1,'loadCard2', 'loadCard2', 'Inmobiliaria', '', '/static/img/equipo7-esperanza.jpeg', '',
                        get_params('main25n')],
    ['_20_20_50_60', 'main256', 1, 1,'loadCard2', 'loadCard2', 'Otros Servicios', '', 'fa-th', '',
                        get_params('main25n')],
    # ['_20_20_50_70', 'main257', 0, 0,'loadCard2', 'loadCard2', '', '', '', '',
    #                     get_params('main25n')],
    # ['_20_20_50_80', 'main258', 1, 0,'loadCard2', 'loadCard2', '', '', '', '',
    #                     get_params('main25n')],
    # ['_20_20_50_90', 'main259', 0, 0,'loadCard2', 'loadCard2', '', '', '', '',
    #                     get_params('main25n')],
    ['_20_20_50_XX', 'main25x', 0, 0,'', 'loadCard3', 'Servicio Desplegado', '', '', '',
                        get_params('main25n')],
    #====================================================
    ['_20_30', 'main3', 1, 0,'', '', 'main3'],
    #======================================================
    ['_20_40', 'main4', 1, 0,'', '', ''],
    ...
    ['_20_40_50_10', 'main451', 1, 1,'loadCard2', 'loadCard2', '', '', 'fa-map-signs', '',
                        get_params('main45n')],
    ['_20_40_50_20', 'main452', 1, 1,'loadCard2', 'loadCard2', '', '', 'fa-map-signs', '',
                        get_params('main45n')],
    ['_20_40_50_30', 'main453', 1, 1,'loadCard2', 'loadCard2', '', '', 'fa-map-signs', '',
                        get_params('main45n')],
    ['_20_40_50_40', 'main454', 1, 1,'loadCard2', 'loadCard2', '', '', 'fa-map-signs', '',
                        get_params('main45n')],
    # ['_20_40_50_50', 'main455', 1, 0,'loadCard2', 'loadCard2', '', '', 'fa-map-signs', '',
    #                     get_params('main45n')],
    # ['_20_40_50_60', 'main456', 0, 0,'loadCard2', 'loadCard2', '', '', 'fa-map-signs', '',
    #                     get_params('main45n')],
    # ['_20_40_50_70', 'main457', 0, 0,'loadCard2', 'loadCard2', '', '', 'fa-map-signs', '',
    #                     get_params('main45n')],
    ...
    ['_20_70_50_60', 'main756', 1, 1,'loadCard2Team', 'loadCard2Team', 'Issa', '','/static/img/equipo6-issa.jpeg','',
                     get_params('main75n')],
    # ['_20_70_50_70', 'main757', 0, 0,'loadCard2Team', 'loadCard2Team', 'Esperanza', '','/static/img/equipo7-esperanza.jpeg','',
    #                  get_params('main75n')],
